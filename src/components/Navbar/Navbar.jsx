  ...
  return (
    <>
      <motion.nav
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        className="fixed w-full bg-gradient-to-r from-gray-100 to-gray-200 z-50"
      >
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center space-x-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="hidden lg:block bg-emerald-600 text-white px-6 py-2 rounded-md text-sm font-medium"
